...
class Warehouse(Machine):
    ...
    def __init__(self, revpi, name: str):
        ...
        # get motors
        self.motor_loading = Motor(self.revpi, self.name + "_ARM", "loading")
        self.motor_hor = Motor(self.revpi, self.name + "_CRANE", "horizontal")
        self.motor_ver = Motor(self.revpi, self.name + "_ARM", "vertical")
